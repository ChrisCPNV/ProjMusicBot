...
const commands = [];
const foldersPath = path.join(__dirname, 'commands'); // search for all the commands in the folder
const commandFolders = fs.readdirSync(foldersPath);

for (const folder of commandFolders) { // take the files from said folder
